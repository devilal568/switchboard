...
pub struct AeronUdpPublisher {
    publication: AeronPublication,
    _aeron: Aeron,
}

impl Publication for AeronUdpPublisher {
...
impl Publisher for AeronUdpPublisher {
...
impl Drop for AeronUdpPublisher {
    fn drop(&mut self) {
        self.cleanup();
    }
}
...
pub struct AeronUdpExclusivePublisher {
    publication: AeronExclusivePublication,
    _aeron: Aeron,
}

impl Publication for AeronUdpExclusivePublisher {
    type Config = AeronConfig;
...
impl Publisher for AeronUdpExclusivePublisher {
    fn publish(&mut self, payload: &[u8]) -> Result<(), SwitchBoardError> {
...
impl Drop for AeronUdpExclusivePublisher {
    fn drop(&mut self) {
        self.cleanup();
    }
}
...
pub struct AeronUdpSubscriber {
    subscription: AeronSubscription,
    _aeron: Aeron,
}

impl Subscription for AeronUdpSubscriber {
    type Config = AeronConfig;
...
impl Subscriber for AeronUdpSubscriber {
...
impl Drop for AeronUdpSubscriber {
    fn drop(&mut self) {
        self.cleanup();
    }
}
